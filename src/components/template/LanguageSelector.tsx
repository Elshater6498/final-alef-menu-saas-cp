...
const languageList = [
    { label: 'English', value: 'en', flag: 'us', dir: 'ltr' },
    { label: 'Arabic', value: 'ar', flag: 'ar', dir: 'rtl' },
]
...
const _LanguageSelector = ({ className }: CommonProps) => {
    ...
    const onLanguageSelect = (lang: string, dir: string) => {
        ...
        updateDirection(dir as Direction)
    }
        ...
        <Dropdown renderTitle={selectedLanguage} placement="bottom-end">
            {languageList.map((lang) => (
                <Dropdown.Item
                    ...
                    eventKey={lang.label}
                    onClick={() => onLanguageSelect(lang.value, lang.dir)}
                >
