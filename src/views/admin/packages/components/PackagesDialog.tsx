...
const PackagesDialog = (props: Props) => {
    ...
    const validationSchema = Yup.object().shape({
        ...
        enFeatures: Yup.array()
            .of(Yup.string())
            .required(`${t('general.field-is-required')}`),
        frontPermissions: Yup.array().required(
    ...
    const fieldFeedback = (
        form: FormikProps<PackagesDialogForm>,
        name: string
    ) => {
    ...
    const handleFormSubmit = async (values: PackagesDialogForm) => {
        ...
        for (let index = 0; index < values.frontPermissions!.length; index++) {
            formData.append(
                'frontPermissions',
                values.frontPermissions![index].value
            )
        }
        formData.append(
            'details',
            ...
            <Formik
                initialValues={
                    props.selectedRow.name
                        ? {
                              name: JSON.parse(props.selectedRow.name!)
                                  ?.ar as string,
                              enName: JSON.parse(props.selectedRow.name!)
                                  ?.ar as string,
                              price: props.selectedRow.price,
                              currency: props.selectedRow.currency?.iso3,
                              details: JSON.parse(props.selectedRow.details!)
                                  ?.ar as string,
                              enDetails: JSON.parse(props.selectedRow.details!)
                                  ?.en as string,
                              ...
                              frontPermissions: [
                                  ...addons.map((item) => {
                                      if (
                                          props.selectedRow.frontPermissions?.includes(
                                              item.value
                                          )
                                      ) {
                                          return item
                            ...
                            <FormContainer className="">
                                <div className="w-full h-[400px] overflow-auto px-1 ">
                                    ...
                                    <FormItem
                                        htmlFor="duration"
                                        label={`${t(
                                            'package-management.Package duration'
                                        )}  (${t('package-management.month')})`}
                                        invalid={
                                    ...
                                    <FormItem
                                        ...
                                        errorMessage={
                                            errors.frontPermissions as string
                                        }
                                    >
                                    ...
                                    <div className="w-full flex gap-4">
                                        <FormItem
                                            ...
                                            label={`${t(
                                                'package-management.package-features'
                                            )}`}
                                            invalid={
                                                !!(
                                                    errors.features &&
                                                ...
                                                {({ form, remove, push }) => (
                                                    <div className="!w-full flex flex-col gap-4">
                                                        ...
                                                        <div>
                                                            ...
                                                            >
                                                                {t(
                                                                    'package-management.add feature'
                                                                )}
                                                            </Button>
                                                        </div>
                                                    </div>
                                        ...
                                        <FormItem
                                            className="w-full flex items-start gap-4"
                                            label={`${t(
                                                'package-management.package-features-en'
                                            )}`}
                                            invalid={
                                                !!(
                                                    errors.enFeatures &&
