...
const ClientDialog = (props: Props) => {
    ...
    const permissionsList = {
        rates: ['rates.list', 'rates.read', 'rates.delete'],
        orders: ['orders.list', 'orders.update'],
    }
    ...
    useEffect(() => {
        ...
        if (props.selectedRow.name) {
            for (let index = 0; index < addons.length; index++) {
                ...
                console.log(
                    props.selectedRow.permissions?.includes('orders.list') &&
                        element.value == 'orders'
                )
                console.log(
                    props.selectedRow.permissions?.includes('rates.list') &&
                        element.value == 'rates'
                )
                ...
                initialValues={
                    props.selectedRow.name
                        ? {
                              ...
                              price: props.selectedRow.planPrice,
                            ...
                            <FormContainer className="flex flex-col items-center ">
                                <div className="w-full h-96 overflow-y-auto px-4">
                                    ...
                                    <FormItem
                                        ...
                                        errorMessage={
                                            typeof errors.responsiblePerson ===
                                            'string'
                                                ? errors.responsiblePerson
                                                : undefined
                                        }
