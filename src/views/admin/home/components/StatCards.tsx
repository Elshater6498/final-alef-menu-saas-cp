...
import { MdOutlineAdminPanelSettings, MdOutlineCategory, MdOutlineDeliveryDining, MdPersonOutline } from 'react-icons/md'
...
const StatCards = ({ isLoading, statistics }: Props) => {
  ...
  const totalOrders = (statistics?.orders_by_type?.delivery || 0) +
          ...
          {isLoading ? (
            ...
            <div className="space-y-2">
              <div className="flex items-center gap-2">
                ...
                <p className="text-gray-600 text-xl font-semibold">{stat.title}</p>
              </div>
              <div className="flex items-center gap-2">
