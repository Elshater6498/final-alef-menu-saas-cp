...
const UsersDialog = (props: Props) => {
    ...
    const permissionsList = {
        ...
        restaurants: ['restaurants.read', 'restaurants.update'],
                    ...
                    props.selectedRow.name
                        ? {
                              ...
                              permissions: [
                                  ...options.map((item) => {
                                      if (
                                          props.selectedRow.permissions?.includes(
                                              'categories.list'
                                          ) &&
